...
function draw_joystick( joystick, side, x, y )
    ...
    -- stick button inner
    love.graphics.setColor( unpack(stick_button_colour) )
...
function draw_bumper_and_trigger( joystick, side, x, y )
    ...
    love.graphics.line(unpack(rect_shape))
    ...
    love.graphics.line( unpack( stretch_rect_shape( trigger_amount * 80 ) ) )
    love.graphics.pop()
end
...
function draw_back_and_start(joystick, x, y, xoff)
    ...
    love.graphics.line( unpack( small_rect_shape ) )
...
function draw_dpad_buttons( joystick, x, y )
    ...
    love.graphics.line(unpack( dpup_line ))
    love.graphics.pop()
...
function JoystickTest:draw()
    ...
    for i, joystick in ipairs(joysticks) do
        ...
        draw_joystick(joystick, "right", lstick_pos.x+150, lstick_pos.y )
        draw_face_buttons(joystick, lstick_pos.x+210, lstick_pos.y-60 )
        draw_dpad_buttons(joystick, lstick_pos.x-60, lstick_pos.y-60 )
        draw_bumper_and_trigger( joystick, "left", lstick_pos.x, lstick_pos.y - 130 )
        draw_bumper_and_trigger( joystick, "right", lstick_pos.x+150, lstick_pos.y - 130 )
        draw_back_and_start(joystick, lstick_pos.x, lstick_pos.y-90, 150)
    end
